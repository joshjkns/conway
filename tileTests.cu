...
__global__ void testKernel(){
    ...
    uint64_t r30 = 0x0000000000000E00ULL;  // Row 3, left half
    ...
    // printf("SingleWord tests:\n");

    // r = oneStepReduceSquareSingleWord(r00,r01,r10,r11,r20,r21,r30,r31,r40,r41,r50,r51);

    // for (int row = 0; row < 4; row++) {
    //     for (int col = 0; col < 2; col++) {
    //         printf("output[%d][%d] =", row, col);
    //         print_binary64(r.store[row][col]);
    //         printf("\n");
    //     }
    // }
    ...
    // printf("LOP3 V1 tests:\n");

    // r = oneStepReduceSquareLOP3v1(r00,r01,r10,r11,r20,r21,r30,r31,r40,r41,r50,r51);
    ...
    printf("LOP3 V2 tests:\n");

    r = oneStepReduceSquareLOP3v2(r00,r01,r10,r11,r20,r21,r30,r31,r40,r41,r50,r51);
